...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('sites', function (Blueprint $table) {
            ...
            // Make places_id nullable and drop+re-add unique (SQLite allows multiple NULLs natively)
            $table->dropUnique(['places_id']);
            $table->string('places_id')->nullable()->change();

            $table->string('business_name')->nullable()->after('places_id');
            ...
            $table->json('settings')->nullable()->after('services_cta_link');
        });
    }
